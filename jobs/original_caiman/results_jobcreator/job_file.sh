...
#SBATCH --job-name=jobcreator_caiman_env                   #This is the name of your job
...
#SBATCH --output=results_jobcreator_20200916/myrun.o%j     #These are the STDOUT and STDERR files
#SBATCH --error=results_jobcreator_20200916/myrun.e%j
...
conda env export > results_jobcreator_20200916/job_$SLURM_JOBID_env.yml

caiman_runner --file $TMP --ncpus 4 --mc_settings mcorr_settings.json --cnmf_settings cnmf_settings.json --qc_settings default

for file in $TMP/*.mmap; do cp "$file" results_jobcreator_20200916;done
for file in $TMP/*.hdf5; do cp "$file" results_jobcreator_20200916;done
for file in $TMP/*.pkl; do cp "$file" results_jobcreator_20200916;done
